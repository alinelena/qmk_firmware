...
def get_key_labels(keymap, keymap_c):
    ...
    specials = {'SC_LSPO': ['⇧','('],'SC_RSPC':['⇧',')'],'TT(_LWR)':['⇓'],'TT(_RSE)':['⇑'],'G(KC_P)':['🖵'],
                ...
                'MS_BTN1':['🖰','1'],'MS_BTN2':['🖰','2'],'MS_BTN3':['🖰','3'],'MS_BTN4':['🖰','4'],
                ...
                'RGB_SPI':['P','▲'],'RGB_SPD':['P','▼'],
                'RGB_UON':['U','●'],'RGB_UOF':['U','○'],
                'RGB_M_P':['l','■'],'RGB_MODE_PLAIN':['l','■'],
                'RGB_M_B':['l','∿'],'RGB_MODE_BREATHE':['l','∿'],
                'RGB_M_R':['l','⌒'],'RGB_MODE_RAINBOW':['l','⌒'],
                'RGB_M_SW':['l','↻'],'RGB_MODE_SWIRL':['l','↻'],
                'RGB_M_SN':['l','∽'],'RGB_MODE_SNAKE':['l','∽'],
                'RGB_M_K':['l','♞'],'RGB_MODE_KNIGHT':['l','♞'],
                'RGB_M_X':['l','❄'],'RGB_MODE_XMAS':['l','❄'],
                'RGB_M_G':['l','▒'],'RGB_MODE_GRADIENT':['l','▒'],
                'RGB_M_T':['l','✓'],'RGB_MODE_RGBTEST':['l','✓'],
                'RGB_M_TW':['l','✦'],'RGB_MODE_TWINKLE':['l','✦'],
                'KC_TRNS':['tran'],'_______':['tran']}
