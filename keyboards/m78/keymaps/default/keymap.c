...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = KEYMAP(
       KC_ESC,           KC_AUDIO_MUTE,      KC_AUDIO_VOL_UP,  KC_AUDIO_VOL_DOWN,   KC_MEDIA_PREV_TRACK, KC_MEDIA_PLAY_PAUSE,  KC_MEDIA_NEXT_TRACK,   KC_F7,  KC_FIND,   KC_EXECUTE,  KC_PSCREEN,      KC_SYSTEM_SLEEP, KC_SYSTEM_WAKE,
      ...
      KC_LSPO, KC_NONUS_BSLASH,         KC_Z,    KC_X,     KC_C,  KC_V,   KC_B,    KC_N,   KC_M, KC_COMM,  KC_DOT,       KC_UP,     KC_NUHS,
  ...
  [_Fortran] = KEYMAP(
      ...
      KC_TRNS, KC_TRNS,     F_Z,     F_X,     F_C,     F_V,     F_B,     F_N,     F_M, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
