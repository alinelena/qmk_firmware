...
[_QW] = LAYOUT_ortho_8x16ish(
    KC_A   , KC_BRID   , KC_BRIU    , KC_D   , KC_SLEP    , KC_WAKE  , KC_F  , KC_G  , KC_H   , KC_I   , KC_J, KC_VOLD, KC_MPLY, KC_VOLU, KC_PWR   ,
    KC_B , KC_F13 , KC_F14  , TEST , KC_F16  , KC_F17, KC_F18, KC_F19, KC_F20 , KC_F21 , KC_F22 , KC_F23 , KC_F24 , KC_NUM , KC_S ,
    KC_C , KC_F1  , KC_F2   , KC_F3  , KC_F4   , KC_F5 , KC_F6 , KC_F7 , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_M   , KC_INS , KC_HOME,
    KC_D , KC_1   , KC_2    , KC_3   , KC_4    , KC_5  , KC_6  , KC_7  , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , KC_BSPC, KC_PSLS, KC_PAST,
    KC_E , KC_Q   , KC_W    , KC_E   , KC_R    , KC_T  , KC_Y  , KC_U  , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC, KC_P7  , KC_P8  , KC_P9  ,
    KC_F, KC_A   , KC_S    , KC_D   , KC_F    , KC_G  , KC_H  , KC_J  , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_ENT , KC_P4  , KC_P5  , KC_P6  ,
    KC_G, KC_NUHS, KC_Z    , KC_X   , KC_C    , KC_V  , KC_B  , KC_N  , KC_M   , KC_COMM, KC_DOT , KC_UP  , KC_SLSH, KC_P1  , KC_P2  , KC_P4  ,
    KC_H, KC_LGUI, TT(_LWR), KC_LALT, TT(_RSE), KC_SPC, KC_SPC, KC_SPC, KC_RALT, SC_RSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_APP , KC_P0  , KC_PDOT
),
[_LWR] = LAYOUT_ortho_8x16ish(
