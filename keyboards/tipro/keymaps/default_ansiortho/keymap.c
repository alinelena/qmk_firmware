...
[_ADJ] =  LAYOUT_ansiortho_8x16(
    _______, QK_BOOT, _______, _______, _______, _______, RM_TOGG, RM_NEXT, RM_PREV,RGB_M_G, QK_BOOT, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, RM_HUEU, RM_SATU, RM_VALU, _______, _______, _______, _______, _______, _______,
