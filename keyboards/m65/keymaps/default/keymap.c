...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LWR] = LAYOUT_ortho_5x13(
       KC_GRV , KC_MUTE, KC_VOLU, KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT, KC_extd, KC_SLEP, KC_WAKE, KC_PSCR, KC_DEL , KC_EQL  ,
  ...
  [_RSE] = LAYOUT_ortho_5x13(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, A(KC_F2), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS ,
