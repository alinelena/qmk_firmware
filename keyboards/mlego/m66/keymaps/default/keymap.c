...
*/
  ...
  [_ADJ] = LAYOUT_ortho_5x14(
      RM_NEXT, RM_PREV, A(KC_F2), _______, _______, _______, _______, _______, _______, _______, _______, RGB_M_T , RGB_M_SW, _______,
      RM_HUEU, RM_HUED , RGB_M_P , _______,  QK_RBT, _______, _______, _______, _______, _______, _______, _______ , RGB_M_SN,
      RM_SATU, RM_SATD , RGB_M_B , _______, _______, _______, _______, _______, _______, _______, _______, _______ , RGB_M_K ,
      RM_VALU, RM_VALD , RGB_M_R , _______, _______, _______, QK_BOOT, _______, _______, _______, _______, _______ , RGB_M_X ,
