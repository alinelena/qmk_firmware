...
*/
  [_ADJ] = LAYOUT_ortho_5x14(
      RGB_MOD, RGB_RMOD, A(KC_F2), _______, _______, UC_LINX,  UC_WIN, UC_WINC,  UC_MAC, UC_EMAC, _______, RGB_M_T , RGB_M_SW, RGB_TOG,
      RGB_HUI, RGB_HUD , RGB_M_P , _______,  QK_RBT, _______, _______, _______, _______, _______, _______, _______ , RGB_M_SN,
      RGB_SAI, RGB_SAD , RGB_M_B , _______, UC_NEXT, _______, _______, _______, _______, _______, _______, _______ , RGB_M_K ,
      RGB_VAI, RGB_VAD , RGB_M_R , _______, UC_PREV, _______, _______, QK_BOOT, _______, _______, _______, _______ , RGB_M_X ,
